...
2. Отправьте сообщение через [Security Advisories](https://github.com/Zorin-Alexey/di/security/advisories/new) репозитория (после публикации замените URL на актуальный).
